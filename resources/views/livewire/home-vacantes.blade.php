<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="font-extrabold text-4xl text-gray-200 mb-12">Nuestras Vacantes Disponibles</h3>
                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        ...
                        <div class="mt-5 md:mt-0">
                            ...
                            p-3 m-3 text-sm uppercase 
                            font-bold text-white rounded-lg block text-center" 
