<div class="bg-gray-100 p-5 mt-10 flex flex-col justify-center items-center">
    <h3 class="text-center text-2xl font-bold my-4 text-gray-800">Postularme a esta vacante</h3>
    ...
    @else
        <form class="w-96 mt-5" wire:submit.prevent='postularme'>
            ...
            <x-primary-button class="my-5 dark:bg-indigo-500 dark:hover:bg-indigo-600 dark:text-white">
                {{__('Postularme')}}
            </x-primary-button>
